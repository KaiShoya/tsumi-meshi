...
- **Status update**: Folder UI and unit tests implemented (see `app/pages/folders`, `app/components/FolderSelector.vue`, `app/stores/data/folders.ts`, `tests/stores/folders.spec.ts`, `tests/repos/folders.spec.ts`). Integration tests and API docs update remaining.
